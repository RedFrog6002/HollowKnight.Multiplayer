...
namespace MultiplayerServer
{
    public class Player : MonoBehaviour
    {
        ...
        public void Initialize(byte id, string username, string animation, int health, int maxHealth, int healthBlue, bool isHost, int team, string chat, bool pinenabled, Vector3 pinposition)
        {
            this.id = id;
